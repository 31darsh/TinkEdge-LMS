    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl shadow-slate-200/60 p-8 border border-slate-100">
        ...
        <div className="grid grid-cols-2 gap-3 mb-3">
          ...
          <button onClick={() => handleDemoLogin('institute-admin', 'Shruti', 'SJR PUBLIC School')} className="py-2.5 text-[10px] font-bold bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all shadow-sm">Institute Admin</button>
        </div>
